...
(function($){
    ...
    $.fn.casmenu=function(opts){
        ...
        AI.opts.ulObj['level_1'] = '<select class="casmenu form-control ma-top-10" name="type[]" level="1">';
        ...
        $("body").on("change", ".casmenu", function(){
            ...
            if(typeof(AI.opts.ulObj['level_'+level]) == "undefined" || typeof(AI.opts.ulObj['level_'+level][name]) == "undefined"){
                ...
                AI.opts.ulObj['level_'+level][name] = '<select class="casmenu form-control ma-top-10" name="type[]" level="'+level+'">';
